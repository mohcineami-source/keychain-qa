...
(function () {
  ...
  /* ---------- FAQ (data-driven) ---------- */
  var FAQ = [
    { q: "كيف تشتغل النشّافة؟ هل هي مثل الدراير الكبير؟",
    ...
    { q: "الجو عندنا حار، ليش أحتاج نشّافة؟",
      a: "مو بس للشتاء — الرطوبة والعجاج يفسدون الغسيل المنشور، والشقق الحديثة بلا شرفة، والبيت المكيّف البارد ما ينشّف الغسيل بسرعة. نَدى تنشّف داخل بيتك بأي وقت، وتحافظ على خصوصية ملابسك الداخلية وملابس الصلاة." },
    { q: "هل هي آمنة على الملابس والأقمشة الحساسة؟",
      a: "نعم. الحرارة منخفضة ولطيفة 40-45°، وما فيه احتكاك ولا أسطوانة — فما فيه تقلّص ولا تشابك ولا بهتان. مناسبة للقطع اليومية وملابس الرضّع وملابس الصلاة. القطع الثقيلة جداً مثل البطانيات السميكة تحتاج وقت أطول." },
    { q: "هل هي آمنة أخليها شغّالة وأطلع من الغرفة؟",
      a: "فيها مؤقّت يفصلها تلقائياً بعد انتهاء الوقت، والحرارة منخفضة، وعنصر PTC ينظّم حرارته بنفسه وما يطلّع حرارة زايدة. مع ذلك، مثل أي جهاز كهربائي، يوضع على سطح ثابت جاف بعيد عن الماء المباشر." },
    { q: "أقدر آخذها معاي بالسفر؟",
      a: "أكيد — تنطوي مسطّحة ووزنها خفيف، تدخل شنطتك بسهولة وتشتغل على كهرباء 220-240 فولت. مثالية للفندق، السكن الجامعي، العزبة، والشاليه — تنشّف ملابسك وين ما نزلت." },
    { q: "كم تحتاج وقت لتنشيف الملابس؟",
      a: "يعتمد على نوع وسماكة القطع وكميتها ودرجة رطوبتها. القطع العادية تنشف بوقت مريح داخل البيت، والقطع الأثقل تحتاج وقت أطول أو أكثر من دورة. مصممة للتنشيف على شكل دفعات." },
    { q: "كم حجمها وهي مطوية وكيف أخزّنها؟",
      a: "تنطوي لمقاس صغير حوالي 35×26×15 سم ووزنها 1.55 كجم بس، فتدخل درج أو خزانة أو شنطة بسهولة — مثالية للشقق الصغيرة وللعزبة والسفر." },
    { q: "كيف يتم الدفع ومتى؟",
      a: "الدفع عند الاستلام. تفحص المنتج بيدك أول ما يوصلك، وتدفع كاش للمندوب — بدون أي دفع مقدّم أو بطاقة." },
    { q: "وش يصير لو ما عجبتني؟",
      a: "تفحصها قدام المندوب قبل ما تدفع، وإذا ما عجبتك لا تستلمها ولا تدفع شي — بدون أي مخاطرة." },
    { q: "كم يستغرق التوصيل وأي مناطق يغطّي؟",
      a: "التوصيل خلال 24-48 ساعة داخل قطر، ويغطّي مختلف المناطق. نتواصل معك عبر واتساب لتأكيد الطلب والعنوان قبل الإرسال." }
  ];
